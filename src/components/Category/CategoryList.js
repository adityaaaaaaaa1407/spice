              ...
              categories.map(category => {
                ...
                return (
                  <Link to = {`/meal/category/${title}`} className = "category-itm align-center justify-center" key = {id}>
                    <div className='category-itm-img flex align-center justify-center mx-auto p-4'>
                      <img src = {thumbnail} alt = {title} className="w-full h-auto max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl "/>
